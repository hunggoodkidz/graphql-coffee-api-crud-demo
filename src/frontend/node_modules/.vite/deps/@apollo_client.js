...
import {
  ...
  print,
  visit
} from "./chunk-22M3OYOD.js";
import {
  __toESM
} from "./chunk-PHIWC6J7.js";
...
function readJsonBody(response, operation, observer) {
  parseAndCheckHttpResponse(operation)(response).then(function(result) {
    var _a4, _b;
    (_a4 = observer.next) === null || _a4 === void 0 ? void 0 : _a4.call(observer, result);
...
var StoreReader = function() {
  ...
  StoreReader2.prototype.execSelectionSetImpl = function(_a4) {
    ...
    function handleMissing(result2, resultName) {
      var _a5;
      if (result2.missing) {
        missing = missingMerger.merge(missing, (_a5 = {}, _a5[resultName] = result2.missing, _a5));
      }
...
var QueryManager = function() {
  ...
  QueryManager2.prototype.mutate = function(_a4) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      var mutationId, _h, document, hasClientExports2, mutationStoreValue, self;
...
function useLazyQuery(query, options) {
  ...
  var internalState = useInternalState(useApolloClient(options && options.client), (_a4 = merged === null || merged === void 0 ? void 0 : merged.query) !== null && _a4 !== void 0 ? _a4 : query);
